...
META: dict[str, dict[str, str]] = {
    ...
    "fail_threshold": {
        ...
        "body": (
            "Сколько тиков подряд бот должен выглядеть «без свежего heartbeat», чтобы "
            "открыть инцидент и отправить алерт. Единица — чувствительно (один пропуск = алерт). "
            "2–3 — меньше ложных срабатываний при мелких сетевых подёргиваниях."
        ),
        "etalon": "2",
